//
//  OpenGLWaveformViewController.swift
...
class OpenGLWaveformViewController: UIViewController {
    ...
    @IBAction func toggleMicrophonePickerView(sender: UIButton) {
...
extension OpenGLWaveformViewController: EZMicrophoneDelegate {
...
extension OpenGLWaveformViewController: UIPickerViewDataSource, UIPickerViewDelegate {
